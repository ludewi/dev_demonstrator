...
all_numbers = [st.session_state["counter_0"], st.session_state["counter_1"], st.session_state["counter_2"],
               st.session_state["counter_3"],
               st.session_state["counter_4"], st.session_state["counter_5"], st.session_state["counter_6"],
               st.session_state["counter_7"], st.session_state["counter_8"], st.session_state["counter_9"]]
...
d = {'0er': st.session_state["counter_0"], '1er': st.session_state["counter_1"], '2er': st.session_state["counter_2"],
     '3er': st.session_state["counter_3"],
     '4er': st.session_state["counter_4"], '5er': st.session_state["counter_5"], '6er': st.session_state["counter_6"],
     '7er': st.session_state["counter_7"],
...
with st.sidebar:
    ...
    start_training = st.radio("Möchtest du Am Föderierten Training teilnehmen?",
                              ("Ja, teilnehmen", "Nein, nicht teilnehmen"), index=1)
    ...
    class CifarClient(fl.client.NumPyClient):
        ...
        def fit(self, parameters, config):
            ...
            with st.spinner(f"Wir befinden uns gerade in Runde {round_counter} des föderrierten Trainings... "):
                ...
                st.success(f'Training der Runde {round_counter} erfolgreich beendet!')
